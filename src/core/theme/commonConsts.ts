...
export const isAndroid12AndHigher = isAndroid && Platform.Version >= 31;

export const windowWidth = Math.min(windowDimensions.width, windowDimensions.height - (!isIos ? StatusBar.currentHeight || 0 : 0));
export const windowHeight = Math.max(windowDimensions.width, windowDimensions.height - (!isIos ? StatusBar.currentHeight || 0 : 0));
...
export const StatusBarHeightIos = isIos ? isIphoneX ? 70 : 20 : 0;
